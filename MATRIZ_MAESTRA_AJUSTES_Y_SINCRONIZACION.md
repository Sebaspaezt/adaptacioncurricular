...
| **v2.4.0** | 2026-09-22 | Antigravity / NRC / SED | Auditoría completa del repositorio, resolución de dependencias de ruta y encoding en el orquestador maestro, sincronización bidireccional P1 ↔ P2, validación E2E en Chrome headless (100% pruebas superadas en index.html y app_standalone.html) y verificación de compatibilidad dual para GitHub Pages y el subdominio de la Gobernación (`flexedu.nortedesantander.gov.co`). | **OPERATIVO** |
